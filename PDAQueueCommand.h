...
/**
 ...
 @param jsonDict input JSON
 @param keyForMessageQueue Key where contains infromation related to the command
 @param error Parsing error
 @return new instance
 */
+ (nullable id<PDAQueueCommand>)modelObjectFromJSON:(nonnull NSDictionary*)jsonDict key:(nullable NSString*)keyForMessageQueue error:(NSError**)error;
@end
